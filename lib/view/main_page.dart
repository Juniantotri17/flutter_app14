...
import 'package:flutterapp14/model/monster.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text("Hive Database 20160801250"),
        ),
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.hasError)
              ...
              if (monstersBox.length == 0) {
                monstersBox.add(Monster("Portgas D Ace", 1));
                monstersBox.add(Monster("Mugiwara no luffy", 5));
              }
